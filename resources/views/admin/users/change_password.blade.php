...
@section('title', 'Eco Bohol - Edit User Password')
    ...
    <div>
        ...
        <div class="p-8">
            <div class="flex justify-between md:mb-5 border-b-2 pb-5 bg-white">
                <h1 class="text-sm md:text-2xl">Edit User Password</h1>
            ...
            <form
                action="{{ url('/admin/manage-accounts/change-password') }}{{ $user ? '?user_id=' . $user->user_id : '' }}"
                method="POST">
                @method('patch')
                @csrf
